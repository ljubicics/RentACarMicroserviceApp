package com.example.rentacaruserservice.security;
...
public class SecurityAspect {
    ...
    public SecurityAspect(TokenServiceSpecification tokenServiceSpecification) {
        this.tokenServiceSpecification = tokenServiceSpecification;
    }

    @Around("@annotation(com.example.rentacaruserservice.security.CheckSecurity)")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        //Try to parse token
        Claims claims = tokenServiceSpecification.parseToken(token);
